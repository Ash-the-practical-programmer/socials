                ...
                <div class="space-y-5 h-[450px] sm:h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div class="chat chat-start">
                        ...
                        <div class="chat-bubble chat-bubble-neutral text-neutral-content shadow">
                            <p class="font-medium mb-1 text-primary-content/90">Searching across platforms for 'AI in
                                education' (last
                                7d)...</p>
                    ...
                    <div class="chat chat-start">
                        ...
                        <div class="chat-bubble chat-bubble-neutral text-neutral-content shadow">
                            ...
                            <p><strong class="text-warning">Partially True, Lacks Context.</strong> 'EduTrack'
                                documentation mentions
                                keystroke <b>pattern</b> analysis for engagement, not content recording. However,
                                privacy policies are
                                vague.</p>
                            <p class="mt-1 text-xs"><strong class="text-warning">Bias Flag:</strong> Most claims
                                originate from a
                                single competitor's blog post. Seeking independent reviews and user testimonials.</p>
                            <button class="btn btn-xs btn-accent mt-2 text-accent-content">Show Verification
                                Trail</button>
                        </div>
                    </div>
                </div>
